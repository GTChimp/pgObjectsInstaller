...
# 0x0090602fL /pgi_lib/libcrypto.so.0.9.6b
# 0x0090602fL /pgi_lib/libcrypto.so.2
# 0x0090581fL /usr/pgi_lib/libcrypto.so.0
# 0x0090602fL /usr/pgi_lib/libcrypto.so
# 0x0090581fL /usr/pgi_lib/libcrypto.so.0.9.5a
# 0x0090600fL /usr/pgi_lib/libcrypto.so.0.9.6
# 0x0090600fL /usr/pgi_lib/libcrypto.so.1
#
# Searching for OpenSSL static library files.
# 0x0090602fL /usr/pgi_lib/libcrypto.a
# 0x0090604fL /usr/local/ssl/pgi_lib/libcrypto.a
#
