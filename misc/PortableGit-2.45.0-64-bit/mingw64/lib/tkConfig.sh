...
# build directory.
TK_BUILD_LIB_SPEC='-Wl,/mingw64/pgi_lib/libtk86.dll.a'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/mingw64/pgi_lib -ltk86'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-Wl,/mingw64/pgi_lib/libtkstub86.a'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/mingw64/pgi_lib -ltkstub86'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/mingw64/pgi_lib/libtkstub86.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/mingw64/pgi_lib/libtkstub86.a'
