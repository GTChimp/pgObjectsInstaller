...
# Flag, 1: we built a shared pgi_lib, 0 we didn't
TCL_SHARED_BUILD=1
...
# Flags to pass to cc/ld, such as "-R /usr/local/tcl/pgi_lib", that tell the
...
# build directory.
TCL_BUILD_LIB_SPEC='-Wl,/mingw64/pgi_lib/libtcl86.dll.a'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/mingw64/pgi_lib -ltcl86'
...
TCL_PACKAGE_PATH='{/mingw64/pgi_lib}'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-Wl,/mingw64/pgi_lib/libtclstub86.a'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/mingw64/pgi_lib -ltclstub86'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/mingw64/pgi_lib'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/mingw64/pgi_lib/libtclstub86.a'
